...
const removeRule = (state, path, config) => {
  state = removeItem(state, path);
  console.log(config.settings.groupOperators)
  ...
  console.log("hasGroupCountRule",hasGroupCountRule)
  console.log("isEmptyParentGroup",isEmptyParentGroup)
  console.log("canLeaveEmpty",canLeaveEmpty)


  
  if (isEmptyParentGroup && !canLeaveEmpty && false) {
